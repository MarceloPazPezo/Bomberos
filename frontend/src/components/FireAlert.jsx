...
const FireAlert = ({ 
  ...
  const alertConfig = {
    success: {
      ...
      fireIcon: '🚒', // Camión de bomberos para éxito
    ...
    conflict: {
      ...
      fireIcon: '🔥', // Fuego para conflictos
    ...
    security: {
      ...
      fireIcon: '🛡️', // Escudo para seguridad
