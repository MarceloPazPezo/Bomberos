...
export default function EditBomberoModal({ isOpen, bombero, onClose, onSave }) {
  ...
  useEffect(() => {
    if (isOpen && bombero) {
      ...
      console.log("EditBomberoModal - Compañía info:", {
        ...
        final:
          bombero?.informacionPersonal?.compania?.nombre ||
      ...
      if (bombero.email || bombero.informacionPersonal || bombero.ficha) {
        ...
        const licenciaClaseF =
          bombero.informacionPersonal?.licenciaClaseF || bombero.ficha?.licenciaClaseF || false;
        const donante = bombero.informacionPersonal?.donante || bombero.ficha?.donante || false;
        const idTipoSangre =
          bombero.informacionPersonal?.tipoSangre?.id || bombero.ficha?.tipoSangre?.id || "";

        console.log("EditBomberoModal - Loaded data:", {
          email,
          telefono,
          licenciaClaseF,
          donante,
  ...
  useEffect(() => {
    if (isOpen && bombero && (bombero.email || bombero.informacionPersonal || bombero.ficha)) {
      ...
      console.log("EditBomberoModal - Updated data:", {
        email,
        telefono,
        licenciaClaseF,
        donante,
  ...
  const validateDireccionData = (data) => {
    ...
    if (!data.numero || data.numero.trim() === "") {
      ...
      if (!numeroPattern.test(data.numero)) {
        direccionErrors.numero =
          "El número solo puede contener letras, números, espacios y guiones";
      }
    }
          ...
          updateData.direccion = {
            ...
            idComuna:
              (direccionData.idComuna &&
                typeof direccionData.idComuna === "number" &&
                direccionData.idComuna > 0) ||
              (typeof direccionData.idComuna === "string" && direccionData.idComuna.trim() !== "")
                ? direccionData.idComuna
                : undefined,
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 bg-gradient-to-r from-[#4EB9FA] to-[#3A9BD9] rounded-t-2xl">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">Editar Información Personal</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <div>
                  ...
                  <div className="p-2 bg-gray-100 rounded border text-gray-600">
                    {bombero?.apellidos
                      ? Array.isArray(bombero.apellidos)
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-3 p-3 bg-yellow-50 border-l-4 border-yellow-400 rounded-r-lg">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-yellow-900 text-sm">Cambio de Contraseña</h3>
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-100">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                      <MdInfo className="text-green-600 w-5 h-5" />
                    </div>
                    <div>
              ...
              <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-6 border border-amber-100">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-8 h-8 bg-amber-100 rounded-full flex items-center justify-center">
                    <MdDirectionsCar className="text-amber-600 w-5 h-5" />
                  </div>
                  <div>
                    <h3 className="text-base font-semibold text-gray-900">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <MdDirectionsCar className="text-gray-700 w-7 h-7" />
                        <div>
                          <span className="font-medium text-gray-900 text-sm">
                            ¿Tienes licencia Clase F?
                          </span>
                        </div>
                      </div>
                      <ToggleSwitch
